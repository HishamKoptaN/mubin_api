...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'link'                  => ' ',
        'slug'                  => ' ',
        'request_pages' => 'عدد الصحفات',
        'unlimited_pages' => 'عدد صفحات لا محدود',

        "created_at" => 'تاريخ الإنشاء',
        "id" => 'الرمز',
        "updated_at" => 'تاريخ التعديل',
        "post_id" => 'رمز الموضوع',
        "readed_at" => 'تاريخ القراءة',
        "replied_at" => 'تاريخ الرد',
        "request_content" => 'المحتوى',
        "request_pages" => 'عدد الصفحات',
        "request_price" => 'السعر',
        "request_type" => 'نوع المشروع',
        "subject" => 'الموضوع',
        "likes" => 'إعجابات',
        "thumbnail" => 'الصورة',
        "views" => 'المشاهدات',
        "category_id" => 'رمز التصنيف',
        "image" => 'الصورة',
        "link" => 'الرابط',
        "department" => 'القسم',
        "stars" => 'النجوم',
        "status" => 'الحالة',
        "request_project" => "طلب مشروع",
        "wallet_info" => "المحفظة"
    ],
